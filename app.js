...
function multiply(a, b) { //eslint-disable-line
  var productNumeric = a * b;
  var productString = 'The product of ' + a + ' and ' + b + ' is ' + productNumeric + '.';
  return [productNumeric, productString];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  for (var i = 0; i < testArray.length; i++) {
    sumNumeric = sum(sumNumeric, sumArr[i])[0];
  }
  
  var sumString = sumArr.join(',') + ' was passed in as an array of numbers, and ' + sumNumeric + ' is their sum.';
  return [sumNumeric, sumString];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  var productNumeric = 1;
  for (var i = 0; i < multArr.length; i++) {
    productNumeric = multiply(productNumeric, multArr[i])[0];
  }    
  var productString = 'The numbers ' + multArr.join(',') + ' have a product of ' + productNumeric + '.';
  return [productNumeric, productString]; 
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for (var i = 0; i < dynamicArray.length; i++) {
    productNumeric = multiply(productNumeric, dynamicArray[i])[0];
  }    
  var productString = 'The numbers ' + dynamicArray.join(',') + ' have a product of ' + productNumeric + '.';
  return [productNumeric, productString]; 
}
